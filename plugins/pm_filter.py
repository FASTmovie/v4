...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                return await query.answer('♥️ Thank You Fast movie ♥️')
    ...
    if query.data.startswith("file"):
        ...
        if AUTH_CHANNEL and not await is_subscribed(client, query):
            await query.answer("update ചാനലിൽ join ചെയ്യൂ 😒", show_alert=True)
            return
        ident, file_id = query.data.split("#")
        files_ = await get_file_details(file_id)
        if not files_:
        ...
        buttons = [[
            ...
            InlineKeyboardButton('😍update channel😍', url='https://t.me/bhiman1234')
        ], [
            InlineKeyboardButton('🥺Help🥺', callback_data='help'),
            InlineKeyboardButton('👑THE KING👑', url='https://t.me/mrbhiman44')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        await query.answer('♥️ Thank You Fast movie ♥️')
